...
namespace Vyzor.Infrastructure.Migrations
{
    ...
    [Migration("20260916032006_AddAppointmentCart")]
    partial class AddAppointmentCart
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vyzor.Domain.Entities.AppointmentCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppointmentCartItems");
                });
            ...
            modelBuilder.Entity("Vyzor.Domain.Entities.SupportChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Vyzor.Domain.Entities.SupportChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Vyzor.Domain.Entities.SupportChatMessage", b =>
                {
                    b.HasOne("Vyzor.Domain.Entities.SupportChat", "SupportChat")
                        .WithMany("Messages")
